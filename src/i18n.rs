...
static MESSAGES: &[Entry] = &[
    ...
    ("owners.add_person", "Weitere Person hinzufügen", "Add another person"),
    ("owners.remove_person", "Entfernen", "Remove"),
    ("person.display_name", "Anzeigename", "Display name"),
    (
        "person.display_name_help",
        "Falls gesetzt, erscheint dieser Name überall dort, wo die Person angezeigt wird (z. B. im Kehrwoche-Plan) – statt des Namens.",
        "When set, this name is shown instead of the name wherever the person is displayed (e.g. in the Kehrwoche schedule).",
    ),
    ("ownership.people_required", "Ein Eigentum braucht mindestens eine Person.", "An ownership needs at least one person."),
    ("building_owner.people_required", "Ein Gebäudeeigentum braucht mindestens eine Person.", "A building ownership needs at least one person."),
